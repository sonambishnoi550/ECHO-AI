...
const Hero = () => {
  return (
    <div style={{ backgroundImage: `url(./assets/images/png/hero-bg.png)`}} className='bg-hero bg-cover bg-no-repeat bg-center max-xl:h-[774.23px] relative bg-dark-black pb-16 max-lg:h-[880px] max-sm:!h-[800px]'>
      <img src="./assets/images/png/hero-side-image.png" alt="side-img" className='absolute md:max-w-[522px] left-0 top-[13%]'/>
      <Header/>
      <div className='container relative'>
        <div className='flex lg:flex-row flex-col gap-5 max-lg:pt-12'>
          ...
          <div className='absolute right-[-89px] top-[60px] xl:block hidden moveY'>
            <img className='max-w-[470px] h-[559px] w-full pointer-events-none move-y' src="./assets/images/png/robot.png" alt="hero-image" />
          </div>
          <div className='xl:hidden flex justify-center'>
            <img className='w-full max-w-[470px] pointer-events-none move-y' src="./assets/images/png/robot.png" alt="hero-image" />
          </div>
        </div>
      </div>
    </div>
