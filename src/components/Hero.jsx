...
const Hero = () => {
  return (
    <div style={{ backgroundImage: `url(./assets/images/webp/hero-bg.webp)`}} className='bg-cover bg-no-repeat bg-center max-xl:h-[774.23px] relative bg-dark-black pb-16 max-lg:h-[880px] max-sm:!h-[800px]'>
      ...
      <div className='container relative'>
        <div className='flex lg:flex-row flex-col gap-5 max-lg:pt-12'>
          <div className='lg:w-[705px] w-full flex flex-col justify-center items-center xl:pt-[166px] xl:pb-[250.23px]'>
            <h1 className='xl:text-7xl text-white text-center lg:text-6xl md:text-5xl text-custom-4xl leading-custom-sm font-bold'>Innovate, Automate, Accelerate </h1>
            <p className='sm:text-xl text-base font-normal text-center text-white sm:pt-6 pt-5'>Next Gen AI Automation to Scale Your Business.</p>
